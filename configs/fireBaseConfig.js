...
import { getAuth, initializeAuth, getReactNativePersistence, PhoneAuthProvider, signInWithCredential } from "firebase/auth";
...
export { FIREBASE_APP, FIREBASE_AUTH, database, db,PhoneAuthProvider, signInWithCredential  };
