...
//         navigation.setParams({ group: updatedGroup, chatName: updatedGroup.chatName });
//       }
//     };
...
//         {isGroup && group?.users?.some(u => u._id === currentUserId) && (
//           <TouchableOpacity
//             onPress={() => navigation.navigate('GroupDetailScreen', { group })}
//           >
//             <Text style={tw`text-white underline text-sm`}>
//               {group?.groupAdmin?._id === currentUserId ? 'Quản lý nhóm' : 'Xem thành viên'}
//             </Text>
//           </TouchableOpacity>
//         )}
//       </View>
